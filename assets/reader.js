...
(function () {
  ...
  var T = {
    ar: { first:'الأولى', prev:'السابقة', next:'التالية', last:'الأخيرة', volumes:'المجلدات', published:'المنشور', pickVolume:'اختر المجلد', otherVolumes:'مجلدات أخرى', volsNote:'المجلدات غير المفعّلة لم تُنشر بعد.', soon:'قريباً', citeAr:'للإحالة استعمل الصفحة العربية:', machineTr:'ترجمة آلية بالذكاء الاصطناعي، غير مراجَعة وقد تحتوي أخطاء. للإحالة يُعتمد الأصل العربي.', viewAr:'العربية', viewTr:'الترجمة', viewBoth:'كلاهما', viewSide:'مقابل', verse:'الآية', surah:'السورة', surahs:'السور', pickSurah:'اختر السورة', script:'الخط', scriptUthmani:'عثماني', scriptSimple:'بسيط', copyVerse:'نسخ الآية', copyRef:'الإحالة', copyLink:'الرابط', copyDo:'نسخ', ayat:'آية', meccan:'مكية', medinan:'مدنية', textFrom:'النص من', transFrom:'الترجمات عبر', noTr:'لم تُترجم هذه الصفحة بعد؛ النص معروض بالعربية.', draft:'ترجمة أولية غير مراجَعة.', trBy:'الترجمة', home:'الرئيسية', mylib:'مكتبتي', search:'بحث', allBooks:'كل الكتب', startReading:'ابدأ القراءة',
          ...
          contactBody:'للاقتراحات وتصحيح الأخطاء والمساهمة في المكتبة، يرجى التواصل معنا.', searchVerse:'ابحث في الآيات…', vsNone:'لا نتائج', tashkil:'التشكيل', scriptMushaf:'مصحف', scriptAmiri:'أميري', juz:'الجزء', mushafPage:'الصفحة', allSurahs:'كل السور', quickAccess:'وصول سريع', goTo:'اذهب إلى', goVerse:'انتقل', layout:'التنسيق', layoutVerse:'آية بآية', layoutMushaf:'صفحة مصحف', showAs:'العرض', showAll:'كل الآيات', showPaged:'صفحة بصفحة', pageOf:'من', prevPage:'الصفحة السابقة', nextPage:'الصفحة التالية', textView:'النص', searchIn:'البحث في', matchWord:'المطابقة', matchPart:'يحتوي الكلمة', matchWhole:'الكلمة كاملة', inSurah:'في سورة', advHint:'ابحث عن كلمة لمعرفة عدد مواضعها في القرآن وأين وردت.', votd:'آية اليوم', openSurah:'افتح السورة', topSurahs:'أكثر السور وروداً', versesWord:'آية', showAllRes:'عرض كل النتائج', inVerses:'في', across:'من' },
    fa: { first:'نخست', prev:'صفحه قبل', next:'صفحه بعد', last:'پایان', volumes:'مجلدات', published:'منتشرشده', pickVolume:'انتخاب جلد', otherVolumes:'جلدهای دیگر', volsNote:'جلدهای غیرفعال هنوز منتشر نشده‌اند.', soon:'به‌زودی', citeAr:'برای ارجاع از صفحهٔ عربی استفاده کنید:', machineTr:'ترجمهٔ ماشینی با هوش مصنوعی، بازبینی‌نشده و ممکن است خطا داشته باشد. برای ارجاع به متن عربی استناد کنید.', viewAr:'عربی', viewTr:'ترجمه', viewBoth:'هر دو', viewSide:'دوستونه', verse:'آیه', surah:'سوره', surahs:'سوره‌ها', pickSurah:'انتخاب سوره', script:'خط', scriptUthmani:'عثمانی', scriptSimple:'ساده', copyVerse:'کپی آیه', copyRef:'ارجاع', copyLink:'پیوند', copyDo:'کپی', ayat:'آیه', meccan:'مکی', medinan:'مدنی', textFrom:'متن از', transFrom:'ترجمه‌ها از', noTr:'این صفحه هنوز ترجمه نشده است؛ متن عربی نمایش داده می‌شود.', draft:'ترجمهٔ اولیه و بازبینی‌نشده.', trBy:'ترجمه', home:'خانه', mylib:'کتابخانهٔ من', search:'جستجو', allBooks:'همهٔ کتاب‌ها', startReading:'شروع خواندن',
          ...
          contactBody:'برای پیشنهاد، گزارش اشتباه یا همکاری با کتابخانه با ما در تماس باشید.', searchVerse:'جستجو در آیات…', vsNone:'نتیجه‌ای نیافت', tashkil:'اِعراب', scriptMushaf:'مصحف', scriptAmiri:'امیری', juz:'جزء', mushafPage:'صفحه', allSurahs:'همهٔ سوره‌ها', quickAccess:'دسترسی سریع', goTo:'برو به', goVerse:'تأیید', layout:'چیدمان', layoutVerse:'آیه‌به‌آیه', layoutMushaf:'صفحهٔ مصحف', showAs:'نمایش', showAll:'همهٔ آیات', showPaged:'صفحه‌به‌صفحه', pageOf:'از', prevPage:'صفحهٔ قبل', nextPage:'صفحهٔ بعد', textView:'متن', searchIn:'جستجو در', matchWord:'تطبیق', matchPart:'شامل واژه', matchWhole:'واژهٔ کامل', inSurah:'در سوره', advHint:'یک واژه را جستجو کنید تا شمار کاربرد آن در قرآن و آیه‌های آن را ببینید.', votd:'آیهٔ روز', openSurah:'گشودن سوره', topSurahs:'پرکاربردترین سوره‌ها', versesWord:'آیه', showAllRes:'نمایش همهٔ نتایج', inVerses:'در', across:'از' },
    ur: { first:'پہلا', prev:'پچھلا', next:'اگلا', last:'آخری', volumes:'جلدیں', published:'شائع شدہ', pickVolume:'جلد منتخب کریں', otherVolumes:'دیگر جلدیں', volsNote:'غیر فعال جلدیں ابھی شائع نہیں ہوئیں۔', soon:'جلد آ رہا ہے', citeAr:'حوالے کے لیے عربی صفحہ استعمال کریں:', machineTr:'مصنوعی ذہانت سے تیار کردہ مشینی ترجمہ، غیر نظرثانی شدہ اور اس میں غلطیاں ممکن ہیں۔ حوالے کے لیے عربی اصل پر اعتماد کریں۔', viewAr:'عربی', viewTr:'ترجمہ', viewBoth:'دونوں', viewSide:'آمنے سامنے', verse:'آیت', surah:'سورہ', surahs:'سورتیں', pickSurah:'سورہ منتخب کریں', script:'خط', scriptUthmani:'عثمانی', scriptSimple:'سادہ', copyVerse:'آیت نقل کریں', copyRef:'حوالہ', copyLink:'لنک', copyDo:'نقل', ayat:'آیات', meccan:'مکی', medinan:'مدنی', textFrom:'متن بشکریہ', transFrom:'تراجم بشکریہ', noTr:'اس صفحے کا ترجمہ ابھی نہیں ہوا؛ عربی متن دکھایا جا رہا ہے۔', draft:'ابتدائی، غیر نظرثانی شدہ ترجمہ۔', trBy:'ترجمہ', home:'صفحۂ اول', mylib:'میری لائبریری', search:'تلاش', allBooks:'تمام کتب', startReading:'پڑھنا شروع کریں',
    ...
    en: { first:'First', prev:'Previous', next:'Next', last:'Last', volumes:'Volumes', published:'Published', pickVolume:'Choose a volume', otherVolumes:'Other volumes', volsNote:'Greyed volumes have not been published yet.', soon:'Coming soon', citeAr:'For citation use the Arabic page:', machineTr:'Machine translation by AI. Not reviewed and may contain errors — cite the Arabic original, not this translation.', viewAr:'Arabic', viewTr:'Translation', viewBoth:'Both', viewSide:'Side by side', verse:'Verse', surah:'Surah', surahs:'Surahs', pickSurah:'Choose a surah', script:'Script', scriptUthmani:'Uthmani', scriptSimple:'Simple', copyVerse:'Copy verse', copyRef:'Reference', copyLink:'Link', copyDo:'Copy', ayat:'ayat', meccan:'Meccan', medinan:'Medinan', textFrom:'Text from', transFrom:'translations via', noTr:'This page has not been translated yet; the Arabic text is shown.', draft:'Draft translation, not yet reviewed.', trBy:'Translation', home:'Home', mylib:'My library', search:'Search', allBooks:'All books', startReading:'Start reading',
          ...
          contactBody:'For suggestions, corrections, or to contribute to the library, '
                    + 'please get in touch.', searchVerse:'Search verses…', vsNone:'No match', tashkil:'Vowels', scriptMushaf:'Mushaf', scriptAmiri:'Amiri', juz:'Juz', mushafPage:'Page', allSurahs:'All Surahs', quickAccess:'Quick access', goTo:'Go to', goVerse:'Confirm', layout:'Layout', layoutVerse:'Verse by verse', layoutMushaf:'Mushaf page', showAs:'Show', showAll:'All verses', showPaged:'Page by page', pageOf:'of', prevPage:'Previous page', nextPage:'Next page', textView:'Text', searchIn:'Search in', matchWord:'Match', matchPart:'Contains word', matchWhole:'Whole word', inSurah:'In surah', advHint:'Search a word to see how many times it occurs in the Qur’an and where.', votd:'Verse of the day', openSurah:'Open the surah', topSurahs:'Most frequent surahs', versesWord:'verses', showAllRes:'Show all results', inVerses:'in', across:'across' }
  };
  ...
  (function () {
    ...
    /* Not gated on FIXED. An ARABIC page has no data-sitelang, and the guard
       used to return before ever asking — which is why the Arabic Bayt
       al-Ahzan had no page dropdown although its pages.json has always been
       there. Bihar's Arabic pages hide the problem by shipping hardcoded
       .edgewrap tick links, which return above; Bayt al-Ahzan ships neither.
       With FIXED falsy _langBase is just the slug, which is exactly the
       Arabic path. A book with no pages.json still no-ops on the 404. */
    if (!_slug || _slug === 'quran' || _slug === 'mafatih') return;
